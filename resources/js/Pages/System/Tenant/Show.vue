        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Ver Registro: Empresa - {{ form.razon_social_business }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">
                                <span aria-current="location">Ver</span>
                            </li>
                        </ol>
                    </div>
                </div>
...
export default {
    ...
    created() {
        this.form = this.tenant
    },
    methods: {
        submit() {
            this.form
                .post(this.route('admin.tenants.update', this.tenant.id), {
